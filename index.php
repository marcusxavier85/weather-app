...
<head>
    ...
    <script src="index-js.js" defer></script>
</head>
<body>
<div class="background">
    <div class="london-svg">
        <svg class="london-skyline"version="1.0" xmlns="http://www.w3.org/2000/svg"
             width="100vw" height="500.000000pt" viewBox="0 0 1280.000000 640.000000"
        ...
        <div class="days-of-the-week">
            <div class="monday">
                Monday
                <div class="monday-weather">
                </div>
            </div>
            <div class="tuesday">
                Tuesday
                <div class="tuesday-weather">
                </div>
            </div>
            <div class="wednesday">
                Wednesday
                <div class="wednesday-weather">
                </div>
            </div>
            <div class="thursday">
                Thursday
                <div class="thursday-weather">
                </div>
            </div>
            <div class="friday">
                Friday
                <div class="friday-weather"></div>
            </div>
        </div>
</body>
</html>